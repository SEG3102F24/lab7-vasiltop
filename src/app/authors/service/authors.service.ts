...
export class AuthorsService {
  ...
  public addAuthor(book: Author): Observable<Author> {
    return this.http.post<Author>(Url + 'books', book);
  }

  public addAuthorAuthor(id: number, author: Author): Observable<Author> {
  ...
  public updateAuthorAuthors(bookId: number, authorId: number): Observable<any> {
